...
### 📄 近期发表
- **2024**: Transformer-based precipitation nowcasting using multimodal satellite data
- **2024**: Improving ensemble weather forecasting with deep learning post-processing
- **2023**: A comparative study of deep learning architectures for medium-range temperature prediction
...
<div class="grid-container">
  <div class="grid-item">
    <h3><a href="/research/">研究方向</a></h3>
    <p>详细了解我的研究领域和方法</p>
  </div>
  <div class="grid-item">
    <h3><a href="/publications/">论文发表</a></h3>
    <p>查看期刊、会议论文和预印本</p>
  </div>
  <div class="grid-item">
    <h3><a href="/teaching/">教学</a></h3>
    <p>课程信息、教学材料和指导</p>
  </div>
</div>
...
**联系信息**: [ligw8@mail2.sysu.edu.cn](mailto:ligw8@mail2.sysu.edu.cn) | [Google Scholar](https://scholar.google.com/citations?user=xLf7K7wAAAAJ) | [GitHub](https://github.com/zhangminglang42)
