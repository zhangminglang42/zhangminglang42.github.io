...
<div class="publications-container">
  ...
  <div class="publications-content">
    ...
    <h1>Publications</h1>
    <p style="color: #6c757d; margin-bottom: 2rem;">以下是我的学术发表列表，按年份和类别分类。</p>
    ...
    <div class="publication-category">
      ...
      <div class="publication-item">
        ...
        <div class="publication-links">
          <a href="/assets/papers/2024_transformer_precipitation.pdf" class="pdf">PDF</a>
    ...
    <div class="publication-category">
      ...
      <div class="publication-item">
        <div class="publication-title">Real-time hail detection using convolutional neural networks and radar data</div>
        <div class="publication-authors">Liu, H., <strong>Zhang, M.</strong>, Patel, S., et al.</div>
        <div class="publication-venue">AMS Annual Meeting</div>
        <div class="publication-links">
          <a href="#" class="pdf">PDF</a>
        </div>
      </div>
    ...
    <div class="publication-category">
      ...
      <div class="preprint-item">
        <div class="publication-title">AI4Weather: An open benchmark for evaluating AI weather forecasting models</div>
        <div class="publication-authors"><strong>Zhang, M.</strong>, & Research Group</div>
        <div class="publication-venue">Technical Report No. TR-2023-05</div>
        <div class="publication-links">
          <a href="#" class="pdf">PDF</a>
        </div>
      </div>
    ...
    <div style="margin-top: 3rem; padding: 1.5rem; background: #e9ecef; border-radius: 8px; font-size: 0.95rem;">
      <p><strong>Note:</strong> For a complete and up-to-date list, please visit my <a href="https://scholar.google.com/citations?user=xLf7K7wAAAAJ">Google Scholar</a> profile.</p>
